...
def _azure(gen):
    ...
    rows = [
        ...
        ("Virtual Machines", "rg-lab-pd-eu-01", "Production", "production", 6100),
        ("Azure Database for PostgreSQL", "rg-lab-pd-eu-01", "Production", "production", 4300),
        ("Storage", "rg-data-pd-eu-01", "Production", "production", 3800),
        ...
        ("Azure Database for PostgreSQL", "rg-lab-dv-eu-01", "NonProduction", "non-production", 3100),
